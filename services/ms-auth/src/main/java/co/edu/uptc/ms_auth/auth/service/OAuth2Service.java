...
import co.edu.uptc.ms_auth.auth.config.OAuth2Properties;
import co.edu.uptc.ms_auth.auth.dto.AuthResponse;
import co.edu.uptc.ms_auth.auth.dto.oauth.GoogleTokenResponse;
import co.edu.uptc.ms_auth.auth.dto.oauth.GoogleUserInfo;
import co.edu.uptc.ms_auth.auth.model.ExternalIdentity;
import co.edu.uptc.ms_auth.auth.model.Role;
import co.edu.uptc.ms_auth.auth.model.User;
import co.edu.uptc.ms_auth.auth.repository.ExternalIdentityRepository;
import co.edu.uptc.ms_auth.auth.repository.RoleRepository;
